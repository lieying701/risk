 ...
 */
@Entity
@Table(name = "survey_tunnel")
public class SurveyTunnelEO extends AbstractBaseEntity {

    /**
     * serialVersionUID
     */
    private static final long serialVersionUID = 8795220631963313480L;
    /** 主键 */
    private String pkId;
    /** 外键 */
    ...
    /** 桥梁材质代码 */
    private String bridgeMaterailCode;
    /** 桥梁材质 */
    private String bridgeMaterail;
    /** 其他桥梁材质说明 */
    private String elseBridgeMaterailRmk;
    /** 工程造价 */
     ...
     * 桥梁材质代码
     * 
     * @return the bridgeMaterailCode
     */
    @Column(length = 50)
    public String getBridgeMaterailCode() {
        return this.bridgeMaterailCode;
    }

    /**
     * 桥梁材质代码
     * 
     * @param bridgeMaterailCode
     *            桥梁材质代码
     */
    public void setBridgeMaterailCode(String bridgeMaterailCode) {
        this.bridgeMaterailCode = bridgeMaterailCode;
    }

    /**
     * 桥梁材质
     * 
     * @return the bridgeMaterail
     */
    @Column(length = 120)
    public String getBridgeMaterail() {
        return this.bridgeMaterail;
    }

    /**
     * 桥梁材质
     * 
     * @param bridgeMaterail
     *            桥梁材质
     */
    public void setBridgeMaterail(String bridgeMaterail) {
        this.bridgeMaterail = bridgeMaterail;
    }

    /**
     * 其他桥梁材质说明
     * 
     * @return the elseBridgeMaterailRmk
     */
    @Column(length = 500)
    public String getElseBridgeMaterailRmk() {
        return this.elseBridgeMaterailRmk;
    }

    /**
     * 其他桥梁材质说明
     * 
     * @param elseBridgeMaterailRmk
     *            其他桥梁材质说明
     */
    public void setElseBridgeMaterailRmk(String elseBridgeMaterailRmk) {
        this.elseBridgeMaterailRmk = elseBridgeMaterailRmk;
    }
