 ...
 * @version 1
 */
@Component("suppService")
public class SuppService extends AbstractTaskEventService {
    ...
    public void onEvent(DelegateExecution execution, Map<String, Object> processDefinitionMap, String schemeName,
        ...
        surveyMain.setStatus(SurveyStatusEnums.ADDTASKENTERING.getCode());
        surveyMainService.update(surveyMain);
        this.completeSurveyTask(surveyTask, SurveyStatusEnums.ADDTASKENTERING, OperationType.SUPP, taskEO.getAssignee());
